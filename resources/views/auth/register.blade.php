...
@section('title', 'Register - Obito')
@section('content')
        <x-nav-guest />
        <main class="relative flex flex-1 h-full">
            <section class="flex flex-1 items-center py-5 px-5 pl-[calc(((100%-1280px)/2)+75px)]">
                <form action="{{ route('register') }}" class="flex flex-col h-fit w-[510px] shrink-0 rounded-[20px] border border-obito-grey p-5 gap-4 bg-white" method="POST" enctype="multipart/form-data">
                    @csrf
